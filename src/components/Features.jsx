const Features = () => {
    return (
      <section class="bg-[#222831] py-16">
          <div class="lg:max-w-full xl:max-w-screen-md mb-8 lg:mb-16 xl:pl-32 lg:text-center sm:text-center xl:text-start">
        ...
        <div class="py-8 mx-auto max-w-screen-xl sm:py-16 sm:px-8 lg:px-6">
          ...
          <g id="SVGRepo_iconCarrier">
            <g>
              ...
              <h3 class="mb-2 text-xl font-bold text-white">Two-Factor Authentication</h3>
          ...
          <g id="SVGRepo_iconCarrier">
            ...
            <g>
              ...
              <h3 class="mb-2 text-xl font-bold text-white">Vote Tallying</h3>
              <p class="text-gray-500 dark:text-gray-400">
          ...
          <g id="SVGRepo_iconCarrier">
            ...
            <polyline className="cls-1" points="19.64 14.86 16.3 18.2 14.39 16.3"></polyline>
              ...
              <h3 class="mb-2 text-xl font-bold text-white">Voter Authentication</h3>
              <p class="text-gray-500 dark:text-gray-400">
